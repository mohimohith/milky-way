                ...
                rf.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.hasChild(id)){
                            Toast.makeText(newuser.this,"User id already exists",Toast.LENGTH_SHORT).show();
                        }else{
                            insertstudent();
...
bottonnav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.it1:
                startActivity(new Intent(newuser.this,valid.class));
                overridePendingTransition(0,0);
                return true;
            case R.id.it2:
                startActivity(new Intent(newuser.this,main3.class));
                overridePendingTransition(0,0);
                return true;
            case R.id.it3:
                startActivity(new Intent(newuser.this,showbill.class));
                overridePendingTransition(0,0);
                return true;
        }
        return false;
    ...
    private void insertstudent() {
        ...
        updated.updateChildren(users).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(newuser.this,"Succesfully added",Toast.LENGTH_SHORT).show();
                Intent i =new Intent(newuser.this,success.class);
                startActivity(i);
